...
### Next.js 16.2.0+ (Node.js Runtime Middleware)

From Next.js 16.2.0, you can use the Node.js runtime in middleware for full session validation with database checks:
