---
name: cashier-paddle
description: Laravel Laravel Cashier (Paddle) documentation and patterns
when-to-use: Consult when working with cashier paddle
keywords: laravel, php, cashierpaddle
priority: medium
---
