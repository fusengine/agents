...
description: Laravel Eloquent: Serialization documentation and patterns
when-to-use: Consult when working with eloquent serialization
keywords: laravel, php, eloquentserialization
priority: medium
---
