...
description: Laravel Eloquent: Mutators & Casting documentation and patterns
when-to-use: Consult when working with eloquent mutators
keywords: laravel, php, eloquentmutators
priority: medium
---
