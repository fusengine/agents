...
description: Laravel Eloquent: Collections documentation and patterns
when-to-use: Consult when working with eloquent collections
keywords: laravel, php, eloquentcollections
priority: medium
---
