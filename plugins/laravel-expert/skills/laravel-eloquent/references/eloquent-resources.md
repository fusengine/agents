...
description: Laravel Eloquent: API Resources documentation and patterns
when-to-use: Consult when working with eloquent resources
keywords: laravel, php, eloquentresources
priority: medium
---
