...
description: Laravel Eloquent: Relationships documentation and patterns
when-to-use: Consult when working with eloquent relationships
keywords: laravel, php, eloquentrelationships
priority: medium
---
