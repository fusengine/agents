...
# Smart detection: only block actual Next.js code
...
skill_was_consulted "nextjs" "$SESSION_ID" "$PROJECT_ROOT" && exit 0

PLUGINS_DIR="$HOME/.claude/plugins/marketplaces/fusengine-plugins/plugins"
MSG="BLOCKED: Next.js skill not consulted. READ ONE: "
MSG+="1) $PLUGINS_DIR/nextjs-expert/skills/solid-nextjs/SKILL.md | "
MSG+="2) $PLUGINS_DIR/nextjs-expert/skills/nextjs-16/SKILL.md | "
MSG+="3) Use mcp__context7__query-docs (topic: nextjs). After reading, retry."
deny_block "$MSG"
