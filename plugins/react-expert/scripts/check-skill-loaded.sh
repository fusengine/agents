...
REASON="🚫 APEX BLOCK: React documentation not consulted! "
REASON+="CONSULT ONE: "
REASON+="A) Read: $PLUGINS_DIR/react-expert/skills/react-19/SKILL.md | "
REASON+="B) MCP: mcp__context7__query-docs (topic: react) | "
REASON+="C) MCP: mcp__exa__web_search_exa (query: react 19 docs). "
