...
TRACKING_FILE="$TRACKING_DIR/react-$SESSION_ID"
...
REASON="BLOCKED: React skill not consulted. "
REASON+="READ ONE: "
REASON+="1) $PLUGINS_DIR/react-expert/skills/solid-react/SKILL.md | "
REASON+="2) $PLUGINS_DIR/react-expert/skills/react-19/SKILL.md | "
REASON+="3) Use mcp__context7__query-docs (topic: react). "
