...
description: Phase 0 pre-step — infer a Design Read from the brief, then set 3 numeric dials (DESIGN_VARIANCE, VISUAL_DENSITY, MOTION_INTENSITY) that become contractual inputs for every later phase.
...
## The 3 dials (contractual outputs of Phase 0)
...
## Next
These dials feed `1-designing-systems` (composition variety, consistency rules) and
the later generation/motion phases. Do not restate them there — read them as Inputs.
