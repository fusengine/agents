...
Run this pass on **every visible string** before handing copy to Phase 3: headlines, subheads, eyebrows, button labels, body, captions, alt text, footer, error messages. A single failure below is a blocking pre-flight failure, not a warning.
